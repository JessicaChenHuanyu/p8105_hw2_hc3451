...
# Conclusion
Some participants (with id: `r only_in_base`) appear in only the baseline; while some participants appear in only the amyloid datasets. `combined_dataset` (has `r nrow(combined_dataset)` observations) combined participants who appear in both datasets.